...
This repository provides replications files for the paper "Identifying dynamic shifts to careless and insufficient effort behavior in questionnaire responses; A novel approach and experimental validation"

- the JAGS model for the dynamic attention model can be found in "./analysis/jags_dyn.R"
