...
# ReplicationIdentifyingDynamic

<!-- badges: start -->
<!-- badges: end -->

This repository provides replications files for the paper “Identifying
dynamic shifts to careless and insufficient effort behavior in
questionnaire responses; A novel approach and experimental validation”

- the JAGS model for the dynamic attention model can be found in
  “./analysis/jags_dyn.R”
...
- curated in R-package DynExpData
  (<https://github.com/Schmidtpk/DynExpData>)
...
- generates plots mixing_ran1,mixing_ran2,sim_att_ran2,loads_ran2_overp,
  loads_ran2
